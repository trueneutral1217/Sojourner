		    ...
		    if(!mouseOver)
            {
                ...
                switch( e->type )
                {
                    case SDL_MOUSEBUTTONDOWN:
                        ...
                        else if(buttonName == "heal")
                        {
                            std::cout<<"\n user clicked 'heal' button";
                            buttonClicked = 8;
                        }
                        else if(buttonName == "exercise")
                        {
                            std::cout<<"\n user clicked 'exercise' button";
                            buttonClicked = 9;
                        }
                        else if(buttonName == "relax")
                        {
                            std::cout<<"\n user clicked 'relax' button";
                            buttonClicked = 10;
                        }
                        else if(buttonName == "research")
                        {
                        ...
                        else if(buttonName == "closeResearch")
                        {
                            std::cout<<"\n user clicked the 'Close Research' button";
                            buttonClicked = 15;
                        }
                        else if(buttonName == "singleBed")
                        {
                        ...
                        else if(buttonName == "upgradeWater")
                        {
                            std::cout<<"\n user clicked the 'upgradeWater' button";
                            buttonClicked = 19;
                        }
                        else if(buttonName == "waterTank2")
                        {
                            std::cout<<"\n user clicked the 'WaterTank2' button";
                            buttonClicked = 20;
                        }
                        else if(buttonName == "upgradeBattery")
                        {
                            std::cout<<"\n user clicked the 'upgradeBattery' button";
                            buttonClicked = 21;
                        }
                        else if(buttonName == "batteryArray2")
                        {
